...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/reconciliation`. Rebuild with skill-catalogue/package_plugins.py -->
