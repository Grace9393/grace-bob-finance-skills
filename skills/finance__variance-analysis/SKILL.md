---
name: finance__variance-analysis
...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/variance-analysis`. Rebuild with skill-catalogue/package_plugins.py -->
