---
name: finance__financial-statements
...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/financial-statements`. Rebuild with skill-catalogue/package_plugins.py -->
