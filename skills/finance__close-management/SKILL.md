---
name: finance__close-management
...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/close-management`. Rebuild with skill-catalogue/package_plugins.py -->
