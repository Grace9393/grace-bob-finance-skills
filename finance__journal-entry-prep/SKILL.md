---
name: finance__journal-entry-prep
...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/journal-entry-prep`. Rebuild with skill-catalogue/package_plugins.py -->
