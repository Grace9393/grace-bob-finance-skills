...
---
<!-- packaged from the Claude plugin export: plugin `finance`, original path `plugins/finance/skills/audit-support`. Rebuild with skill-catalogue/package_plugins.py -->
